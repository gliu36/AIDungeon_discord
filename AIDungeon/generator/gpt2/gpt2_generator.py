...
from AIDungeon.generator.gpt2.src import encoder, model, sample
...
class GPT2Generator:
    def __init__(self, generate_num=60, temperature=0.4, top_k=40, top_p=0.9, censor=False, force_cpu=False):
